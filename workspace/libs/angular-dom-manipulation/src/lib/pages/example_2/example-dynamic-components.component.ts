...
import { FakedResponseData, PluginComponent, getSyncResponse } from './example-dynamic-components.model';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, PluginOneComponent, PluginTwoComponent, MatButtonModule],
